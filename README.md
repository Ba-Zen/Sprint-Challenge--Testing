...
1. In Jest, what are the differences between `describe()` and `it()` globals, and what are good uses for them?
   Describe creates a block for similar tests. It is used for specific tests.
1. What is the point of `Test Driven Development`? What do you think about this approach?
   TDD makes the code simpler and it build it from the ground up with more security if the system were to mess up somehow. It's easier to pinpoint what went wrong.
